...
(function () {
  ...
  (function scorecard() {
    ...
    const rows = [
      ...
      ['H4', 'teachers', '3 of 5', 'distill 10.0 vs every dose-matched control incl. full-lifetime replay (p≤1.5e-20); random advice poisons. Boundary: global optimism solves small worlds.'],
